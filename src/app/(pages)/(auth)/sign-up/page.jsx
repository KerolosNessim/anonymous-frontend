      ...
      <div className="container">
        <Form {...form} >
          <form onSubmit={form.handleSubmit(onSubmit)} className="xl:w-1/2 xl:mx-auto space-y-6  bg-[#152E3A] border border-primary rounded-xl xl:p-12 p-6">
            ...
            <a href="https://api-production-2e45.up.railway.app/auth/github" className="flex items-center justify-center gap-2 rounded-md hover:bg-primary/90 transition-all duration-300 bg-primary  py-3 font-[family-name:var(--font-fira)]  font-semibold w-full"><FaGithub size={20} />  Sign Up With Github</a>
            <a href="https://api-production-2e45.up.railway.app/auth/google" className="flex items-center justify-center gap-2 rounded-md hover:bg-primary/90 transition-all duration-300 bg-primary  py-3 font-[family-name:var(--font-fira)]  font-semibold w-full"><FaGoogle size={20} />  Sign Up With Google</a>
