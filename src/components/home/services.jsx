    ...
    <section style={{
      ...
      <div className='container space-y-10'>
        ...
        <div className='text-center xl:max-w-xl xl:mx-auto space-y-6'>
          ...
          <h2 className='xl:text-4xl  text-3xl font-bold '>Expose Unknown Threats Become a Problem</h2>
        ...
        <div className='grid grid-cols-12 gap-4'>
          {services.map((item, idx) => (
            <div key={idx} className='text-center col-span-12 md:col-span-6 xl:col-span-4 space-y-4 border border-primary rounded-xl px-6 py-10'>
              ...
              <Link href={`/services/1`} className='text-primary flex items-center justify-center gap-2 font-bold capitalize  hover:gap-4 hover:text-white transition-all duration-300 '>
