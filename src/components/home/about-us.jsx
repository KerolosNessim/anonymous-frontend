    ...
    <section style={{
      ...
      <div className='container  grid grid-cols-12 gap-8 '>
        ...
        <div className='xl:col-span-5 col-span-12 space-y-6'>
          ...
          <p className='text-sm font-bold text-gray-400'>Our mission is to address a critical vulnerability in global cybersecurity: the inability of traditional tools to keep pace with modern, evasive malware.
            Legacy security can’t stop what it doesn’t recognize — like zero-days and polymorphic threats.
          </p>
          <p className='text-sm font-bold text-gray-400'>Reactive tools leave blind spots. Anonymous closes them.
